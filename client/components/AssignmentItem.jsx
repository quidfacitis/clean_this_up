...
const AssignmentItem = ({assignment, toggleMessageModal, deleteAssignment}) => {
  return (
    <div className="staff-member-card">
      ...
      <div className="due-by">Due: {assignment.dueBy}</div>
      ...
      <div className="staff-edit-delete-container">
        <span className="assignment-edit"><Icon icon={editSolid} /></span>
        <span className="assignment-delete" onClick={() => deleteAssignment(assignment.id)}><Icon icon={delete24Filled} /></span>
      </div>
